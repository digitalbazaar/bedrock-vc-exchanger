...
/**
 * If an exchangeId is defined in the config return true.
 *
 * @param {object} options - Options to use.
 * @param {string} options.exchangeId - The id of an exchange.
 *
 * @returns {boolean} Was the exchangeId in exchanges?
 */
export async function exists({exchangeId}) {
  //FIXME store configs in a db
  return !!bedrock.config['vc-exchanger'].exchanges?.[exchangeId];
}
